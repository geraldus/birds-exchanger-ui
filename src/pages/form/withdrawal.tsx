...
export default function () {
    return (
        <div>
            ...
            >
                <div 
                    className="form-group col-12 fee-stats text-muted"
                >
                    <small>
                        <span>
                            Сервисный сбор: #
                        ...
                        <small 
                            className="currency rur"
                        >₽#
                        </small>
                        <small 
                            className="currency pzm"
                        >PZM#
                        </small>
                        <small 
                            className="currency our"
                        >OUR#
                        </small>
                        <small>
                            <span>
            ...
            >
                ...
                >
                    <label 
                        htmlFor="#{adrid}-1"
                        className="rur_sber_tm"
                    >Номер карты СберБанка (₽/RUR)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="rur_alpha_tm"
                    >Номер карты Альфа Банка (₽/RUR)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="rur_tinkoff_tm"
                    >Номер карты Тинькофф Банка (₽/RUR)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="rur_qiwi_tm"
                    >Qiwi кошелёк (номер телефона) (₽/RUR)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="rur_paypal_tm"
                    >Аккаунт PayPal (₽/RUR)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="usd_paypal_tm"
                    >Аккаунт PayPal ($/USD)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="pzm_tm_addr"
                    >Адрес Prizm кошелька (PZM Address)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="btc_addr_tm"
                    >Адрес Bitcoin кошелька  (BTC)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="eth_addr_tm"
                    >Адрес Etherium кошелька (ETH)
                    </label>
                    <label 
                        htmlFor="#{adrid}-1"
                        className="our_addr_tm"
